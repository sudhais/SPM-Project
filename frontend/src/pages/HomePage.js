  ...
  return (
    <Layout>
      ...
      <div className="filters">
        ...
        <div className="filter-tab ">
          ...
          <Select value={type} onChange={(values) => setType(values)}>
            ...
            <Select.Option value="inctive">INACTIVE</Select.Option>
      ...
      >
        ...
        >
          <Form.Item label="Age" name="amount">
          ...
          <Form.Item label="Category" name="category">
            <Select>
              ...
              <Select.Option value="oop">OOP</Select.Option>
              <Select.Option value="inheritence">Inheritence</Select.Option>
              <Select.Option value="abstarct">Abstarct</Select.Option>
              <Select.Option value="interfaces">Interfaces</Select.Option>
              <Select.Option value="size">Size</Select.Option>
              <Select.Option value="relationships">Relationships</Select.Option>
              <Select.Option value="class">Class</Select.Option>
              <Select.Option value="objects">Objects</Select.Option>
            </Select>
          </Form.Item>
        ...
        {showReport ? (
          <PDFViewer width="100%" height={500}>
            <MyPDFDocument /> {/* Place MyPDFDocument component here */}
          </PDFViewer>
        ) : (
          <ReportGenerator
